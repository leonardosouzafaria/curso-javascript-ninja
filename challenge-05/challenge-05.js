...
*/
var array = ['Leonardo', 20, 'masculino', true, 1,80];
...
*/
var array2 = ['Leo Souza', 20, 1.75, true, null];
...
*/
for(var i = 0; i <= 4; i++) {
    console.log(myFunction2(array2, i));
}
...
*/
console.log('O livro Livro 1 tem ' + book("Livro1").quantidadePaginas + ' páginas!' 
);
